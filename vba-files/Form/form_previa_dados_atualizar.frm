VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} form_previa_dados_atualizar 
   Caption         =   "Dados de Usuario"
   ClientHeight    =   9420
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   7755
   OleObjectBlob   =   "form_previa_dados_atualizar.frx":0000
   ShowModal       =   0   'False
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "form_previa_dados_atualizar"
